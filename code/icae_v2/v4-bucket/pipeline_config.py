...
class PipelineConfig:
    ...
    # 체크포인트 경로
    checkpoint_stage_1: str = field(default="",)
    checkpoint_stage_2 : str = field(default="",)
    checkpoint_stage_3: str = field(default="",)
    ...
    # checkpoint_stage_3: str = field(default="/ssd1/donghyeon/icae/out/1210-mintest")
