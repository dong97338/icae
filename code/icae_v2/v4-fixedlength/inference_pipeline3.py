...
lora_config = LoraConfig(r=128, lora_alpha=32, lora_dropout=model_args.lora_dropout, bias="none", task_type="CAUSAL_LM")
...
with open("./cc_ko/stage1_train.jsonl","r") as f: lines = f.readlines()
model.eval()
with torch.no_grad():
