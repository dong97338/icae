...
class ICAE(torch.nn.Module):
    ...
    def _compress2(
        ...
        max_compressed_length = num_segments * self.q_mem_size
        ...
        for segment_idx in range(num_segments):
            ...
            compress_outputs[segment_idx*self.q_mem_size: self.q_mem_size*(segment_idx+1)] = segment_compress_outputs[mem_flag]
